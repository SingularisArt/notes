...
\paragraph{Who} Delegates from  $12$ of the $13$ colonies met in Philadelphia. Only \bf{Rhode Island} did not send a delegation. Many delegates were lawyers. \bf{James Madison} ultimately proposed that the convention's goal should be to form a new government. The delegates debated how to form the best centralized government without restricting the rights of the states or individuals. The convention ultimately came down to compromises. Some famous members of the \bf{Constitutional Convention} are:
...
\paragraph{What} The U.S. Constitution is the founding document of our government. The Constitution is a \bf{"living document"} that provides the structure of our democracy. Our Constitution can be broken down into three major parts:
...
\bf{The Preamble} is the introduction to the Constitution that outlines the goals of the Constitution. The preamble is a $52$ word sentence that sets forth the goals of the U.S. government.

\paragraph{When} In the summer of $1787$, The members of the \bf{Constitutional Convention} took $100$ days to frame our new government. The delegates debated and compromised on how our new government should function. One of the major debates centered on power. The power of the central government vs. the power of states' government.

\paragraph{Where} The delegates convened in \bf{Philadelphia, Pennsylvania} at \bf{Independence Hall}. This meeting of delegates is called the \bf{Constitutional Convention} or \bf{Philadelphia Convention}. This is also where the \bf{Declaration of Independence} was signed.

\paragraph{Why} Their purpose was to establish a legal system of government that corrected the weakness of the \bf{Articles of Confederation} and create a new centralized government. This was our second attempt to create our government.
...
\bf{Article IV} of the Constitution could also be called the \bf{"States Article"}. The $10$th amendment to the Constitution defines the powers of the states.

The $13$ original colonies maintained sovereignty by operating a self-government. However, during the time of the revolution, the independent states needed to work together to form a union, which would eventually create the \bf{United States}. After the founding fathers saw the \bf{Articles of Confederation} fail miserably, they needed to create a centralized government but still maintain the rights of each state.

\begin{definition}[Federalism]
    Federalism is the division of power between the \bf{Federal} and \bf{State} governments. The Constitution outlines the powers and limits of the \bf{National Government}, solidifies the relationship between the levels of government and ensures that the people get their rights.
\end{definition}
...
\bf{State Governments} are also governed by the Constitution. In general, the \bf{State Constitutions} are much longer than the U.S. Constitution. Each state:
...
However, the U.S. Constitution is the \bf{"Supreme Law of the Land"}. 
