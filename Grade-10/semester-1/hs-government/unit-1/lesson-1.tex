...
\subsubsection*{The Purpose of the Government}

The \bf{Government} exists to provide order and safety to its citizens.
Without the \bf{Government} and \bf{Law}, chaos and anarchy would
reign.

The purposes of our \bf{Government} is to keep the peace within its
...
\subsubsection*{How does the Government Carry out its Purpose}
...
\subsubsection*{What are Natural Rights}
...
Enlightenment. John Locke described these rights as those of \bf{"Life,
...
rights, the \bf{Bill of Rights}, as an addition section of the
Constitution. We can trace all of these rights to the ideas of \bf{"Life,
Liberty, and Estate"}.

\subsubsection*{What is Consent of the Governed}
...
\begin{figure}
    \begin{quote}
        \it{That to secure these rights, governments are instituted among men, deriving
...
\subsubsection*{What is Representative Government}

Democracy means \bf{"Rules of the People"}. In history, two basic forms of
...
\begin{definition}[Representative Democracy]
  ...
  through their representatives. We also use the term \bf{"Republic"} to
...
\subsubsection*{What is Limited Government}
...
\subsubsection*{What is Rule of Law}
