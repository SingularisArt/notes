...
\begin{definition}[Algebraic Proofs]
    \begin{itemize}
        \item \textbf{Polynomial Identities} can be proven to be true by simplifying
          the identity through application of \textbf{Algebraic Theorems} and \bf{Principles}.
        \item Start with the side of the identity that can be simplified the easiest.
        \item Sometimes, following a \it{“clue”} will lead to a dead-end in your
          \textbf{Proof}. Do not give up. Just follow a different \it{“clue”}. The more practice you have with proofs, the more you will be able to predict the dead-ends.
    \end{itemize}
\end{definition}
