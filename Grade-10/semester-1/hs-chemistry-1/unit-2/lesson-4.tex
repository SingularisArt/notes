...
The \bf{Principal Quantum Number} refers to the energy levels around the nucleus
where electrons are located. These energy levels are also called \bf{Energy Shells}.

Energy levels contain \bf{Sub-shells} that are designated with letters such as
...
Due to the number of electrons in most atoms, multiple \bf{Sub-shells} exist
within each energy level.

Some \bf{Sub-shells} have multiple orbitals—regions inside an
...
The $s$ \bf{Sub-shell} contains $1$ orbital and is denoted by a line. The electrons
...
\paragraph{The $p$ orbital} The $p$ orbital is dumbbell-shaped.

There are $3$ of these orbitals, one on each axis.

The $p$ \bf{Sub-shell} has $3$ orbitals and is denoted by three lines. The \bf{Sub-shell}
can hold a maximum of $6$ electrons.

\paragraph{The $d$ orbital} The $d$ orbital is nondescript in shape. The $d$ \bf{Sub-shell} has five orbitals and
is denoted by $5$ lines. This \bf{Sub-shell} can hold a maximum of $10$ electrons.

\paragraph{The $f$ orbital} The $f$ orbital is nondescript in shape.

The $f$ \bf{Sub-shell} has $7$ orbitals and is denoted by seven lines. This \bf{Sub-shell}
...
probable placement in energy levels and \bf{Sub-shells}. Remember, within these
\bf{Sub-shells} electrons are in constant motion.
