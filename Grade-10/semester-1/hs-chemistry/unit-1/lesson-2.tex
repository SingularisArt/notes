...
\begin{definition}[Derived Units]
	...
	A very common \bf{Derived Unit} is \bf{Volume}. For liquids and gasses, \bf{Volume} tends to be measured in liters. But, for regular-shaped solids, measurements and calculations can determine their \bf{Volume}. To calculate the \bf{Volume} of the cube in Figure~\ref{fig:3-3-3-cube}, just raise the side measurement to the third power.
...
\begin{example}[Fractional Unit]
    ...
    \begin{align}
    	\frac{0.36 \rm{ \sout{km}}}{1 h} \times \frac{1,000 \rm{ \sout{m}}}{1 \rm{ \sout{km}}} \times \frac{100 cm}{1 \rm{ \sout{m}}}
    \end{align}
