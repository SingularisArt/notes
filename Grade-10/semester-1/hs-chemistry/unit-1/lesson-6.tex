...
\begin{definition}[Homogeneous]
    ...
    Dissolving sugar in a glass of water forms a \textbf{homogeneous} mixture,
...
gold is a \textbf{Pure Substance} because it's made from a single element:
gold.

\begin{definition}[Elements]
    An \textbf{Element} is a substance that cannot be broken down into simpler
    substances. All elements on the periodic table of elements are examples of
    \textbf{Pure Substances}.
\end{definition}

\begin{definition}[Compounds]
    A \textbf{Compound} is matter composed of two or more \textbf{Elements}. A
    molecule is the smallest unit of a \textbf{Compound}. 
...
\begin{definition}[Chemical Separation]
    ...
    from the elements \textbf{Sodium} and \textbf{Chlorine}. A chemical
