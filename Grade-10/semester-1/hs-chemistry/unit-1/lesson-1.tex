\lesson{1}{Sep 07 2021 Tue (11:09:10)}{The Science of Chemistry}{Unit 1}

\subsubsection*{Knowledge that's considered science}
...
\subsubsection*{Answering questions with Science}
...
A scientific method is a series of steps for investigating questions and testing ideas. There are several versions of the \bf{scientific method}, but all of the versions are based on rational thinking, inquiry, and experimentation. The \bf{scientific method} includes five main steps:
...
\begin{itemize}
	...
	\item Hypothesis: Most hypotheses are made with the \bf{"if/then"} statements. If "this" happens, then "that" will take place. This helps you know how one thing can affect another and gives you variables to test.
