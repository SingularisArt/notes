\lesson{3}{Oct 06 2021 Wen (08:43:42)}{Quantization of Energy}{Unit 2}
...
Eventually, electrons fall back to a lower orbit or their ground state; but when they do, they release energy in the form of light. This light appears in different colors, depending on the frequency and wavelength of the light released.
...
\bf{Bohr's model} of the hydrogen atom showed the electrons traveling in specific orbits, or paths, around the nucleus.
...
This can be compared to the orbits of \bf{Bohr's model}. Each orbit has its own small, definite amount of potential energy; scientists say that this energy is quantized.
...
\bf{Planck's hypothesis} about energy and quanta led to the discovery of the \bf{photon}.

\begin{definition}[Photon]
    A photon is a basic particle representing a quantum of energy, E. A photon of light is emitted by an atom when an electron within the atom transitions to a lower energy level.
    
    Conversely, a photon of energy is absorbed by an atom when an electron within the atom moves to a higher energy level. Because energy is transferred in quanta, the photon's entire energy is transferred, not just a fraction of it.
\end{definition}
...
\begin{definition}[Planks Constant]
    ...
    The energy of a photon is directly proportional to the frequency of the photon's emission or absorption. Energy is measured in Joules, $h$ is \bf{Planck's constant} of:

    \[ 6.626 \times 10^{-34} \times s \]
