...
\def\@lesson{}
\def\@lessonabbr{}
\newcommand{\converttolabel}[1]{\expandafter\tokencyclexpress#1\endtokencyclexpress}
\LetLtxMacro{\oldlesson}{\lesson}
\newcommand{\lesson}[4]{
...
\newcommand{\lecture}[4]{
    ...
    \def\@lectureabbr{Lec #1}
		...
		\subsection[\@lectureabbr]{\@fullLecture}
    \label{\@lecture}
	}{
    \def\@lectureabbr{Les #1: #3}
