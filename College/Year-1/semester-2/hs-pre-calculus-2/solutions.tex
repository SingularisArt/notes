...
\begin{solution}
  ...
  Since it takes $40$ minutes to make a full rotation, that implies that it
  takes $20$ minutes to make a half rotation. From that, we can say that it
  takes $10$ minutes to rotate $\frac{1}{4}$ of the rotation. Here's the final
  graph:

  \begin{figure}[H]
    \centering
    \incfig{ferris-wheel-graph}
    \caption{Ferris Wheel Graph}
    \label{fig:ferris_wheel_graph}
  \end{figure} 
\end{solution}
