...
\begin{solution}
  for \textbf{Exercise} \ref{exc:angle_of_theta}

  \[ \sin(\theta) = \frac{4}{5} \qquad \textrm{and} \qquad \cos(\theta) = -\frac{3}{5}\].
\end{solution}

\begin{solution}
  for \textbf{Exercise} \ref{exc:using_r_cos_and_r_sin}
...
\begin{solution}
  for \textbf{Exercise \ref{exc:find_cos}}
...
\begin{solution}
  for \textbf{Exercise \ref{exc:find_tan_sec_csc_and_cot}}
...
\begin{solution}
  for \textbf{Exercise \ref{exc:find_tan_sec_csc_cot_1}}
...
\begin{solution}
  for \textbf{Exercise \ref{exc:find_tan_sec_csc_cot_2}}
...
\begin{solution}
  for \textbf{Exercise \ref{exc:find_tan_sec_csc_cot_3}}
