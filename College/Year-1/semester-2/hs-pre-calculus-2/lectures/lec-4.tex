...
\begin{exc}[Solution here \ref{sol:angle_of_theta}]
...
\begin{figure}[htpb]
  ...
  \begin{tikzpicture}[every text node part/.style={align=center}]
    ...
    % Draw the signs for each quadrant
...
\begin{exc}[Solution here \ref{sol:using_r_cos_and_r_sin}]
...
\begin{figure}[htpb]
  ...
  \begin{tikzpicture}[my angle/.style = {draw, fill=teal!30,
    ...
    % Arc telling the arc specified by theta
    ...
    % Draw the arrow pointing to the triangle
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}[my angle/.style = {draw, fill=teal!30,
      ...
      \draw[red]  (0,0) coordinate[label=below:$A$] (a) --
                  (4,0) coordinate[label=below:$B$] (c) --
                  (4,4) coordinate[label=above:$C$] (b) -- cycle;
...
\begin{exc}[Solution here \ref{sol:find_cos}]
  \label{exc:find_cos}
