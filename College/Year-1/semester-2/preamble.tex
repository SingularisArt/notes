...
\renewcommand{\labelenumi}{{\color{thmbluetextcolor}\arabic{enumi}}} % EX: 1.
\renewcommand{\labelenumii}{{\color{thmbluetextcolor}\arabic{enumi}.\arabic{enumii}}} % EX: 1.1
\renewcommand{\labelenumiii}{{\color{thmbluetextcolor}\arabic{enumi}.\arabic{enumii}.\arabic{enumiii}}} % EX: 1.1.1
\renewcommand{\labelenumiv}{{\color{thmbluetextcolor}\arabic{enumi}.\arabic{enumii}.\arabic{enumiii}.\arabic{enumiv}}} % EX: 1.1.1.1
...
\@ifclasswith{report}{nocolor}{ % Check if we're using the [nocolor] argument in
  ...
  \AddToHook{env/solution/after}{\colorlet{thmprooftextcolor}{thmbluetextcolor}}
  \AddToHook{env/solution/after}{\colorlet{thmprooflinecolor}{thmbluelinecolor}}
  \AddToHook{env/solution/after}{\colorlet{thmproofbackgroundcolor}{thmbluebackgroundcolor}}
...
% Create simple environments without any fancy configuration
