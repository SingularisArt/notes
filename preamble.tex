...
\def\@header{}{}{}{}                                                % {header type}{header number}{header name}{date}
\setcounter{secnumdepth}{0}
\newcommand{\header}[4]{
    \def\@header{\textit{#1 #2: #3} }

    \section[#2. #3]{\hfill #3 \hr \@header \hfill\small\textsf{\mbox{\textbf{#4}}} \newline}
}
...
\fancypagestyle{plain}{                                             % Changes footer and header
    ...
    \fancyfoot[]{\hr\@header\hfill\thepage}                         % EX: header name                       Page: pg #
    \fancyfoot[C]{}                                                 % Center
